...
public class Red_Auditorium extends javax.swing.JFrame {
    ...
    public Red_Auditorium() {
        initComponents();
    }

    public Red_Auditorium(String mail) {
        initComponents();
        email = mail;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kırmızı Konferans Salonu 1");

        jLabel2.setFont(new java.awt.Font("Arial", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Kapasite : 300");
        ...
        hoursPanel.setBackground(new java.awt.Color(153, 153, 153));
        ...
        panelOfButtonsLayout.setHorizontalGroup(
                panelOfButtonsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(hoursPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        scrollPane.setViewportView(panelOfButtons);
                ...
                kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                                .addComponent(addAppointment, javax.swing.GroupLayout.PREFERRED_SIZE, 465, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addAppointmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addAppointmentActionPerformed
        ...
        if (!myM.isMonthAndDaySelected(monthComboBox, daySpinner)) {
            ...
            for (Object o : times) {
                db.addReservation(email, "Kırmızı", month, day, (String) o);
            }
            reservedTimes = db.getDayReservedTimes("Kırmızı", String.valueOf(monthComboBox.getSelectedItem()), (Integer) daySpinner.getValue());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Red_Auditorium().setVisible(true);
            }
        });
    }
